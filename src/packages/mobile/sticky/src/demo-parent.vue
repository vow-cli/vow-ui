 ...
 * @LastEditTime: 2021-08-01 16:37:22
 * @Description: 
-->
<template>
  <div class="sticky-demo">
    <div id="sticky-container">
      <vow-sticky mode="js" :use-window="false">
        <vow-sticky-item :top="0">
          <template #header>
          ...
          <template #body>
            ...
            <vow-sticky mode="js" :use-window="false" container-id="sticky-container">
              <vow-sticky-item :top="54">
                <template #header>
                  <div class="search-box">
                    <vow-icon name="search" size="24" color="#c0c0c0"></vow-icon>
                    <input type="text" disabled placeholder="搜索" />
